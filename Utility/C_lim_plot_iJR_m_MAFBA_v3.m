...
%     axis([0 0.9 0 inf])
    ...
    yyaxis right
    l8= plot(gr,wvec,'-+','Color',color{8},'LineWidth',1, 'markerfacecolor', color{8}, 'MarkerSize', 8 );
    ...
    'ATPS4r flux 0.5x (Membrane)','Glyoxylate shunt ', 'ED pathway','CO_{2} excretion','w_{Cc}' , '\lambda_{ac}');
    set(lgd, 'Box', 'off', 'Location', 'northwest','Fontsize', 16, ...
        'Position',[0.194166667970519 0.36611112303204 0.416249989494682 0.463333319922288]);
%     axis([0 inf -inf 0])
    
    hold off;
    filename = ['MAFBA_wc_f_g_', str,'.png'];
